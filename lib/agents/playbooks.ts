...
// ─── PDM — APRIL 2026 CONTENT CALENDAR ──────────────────────────────
// Mirrors the actual April 2026 tab from PDM's "Social Content Calendar.xlsx"
// (PDM is the brand-level social agency for Prime IV). "Yes" in the
// cascading column = PDM brand-cascades it from the Prime IV corporate
// page so we see it and don't overlap. "No" = non-cascading reel the
// Niceville location posts from its own page using the linked MP4 + audio.
//
// Load with startDate=2026-04-01 to place posts on their actual April
// dates. Captions are verbatim from PDM's sheet so Niceville's page
// language matches the brand.
export const PRIME_IV_PDM_APR_2026: Playbook = {
  id: 'prime-iv-pdm-apr-2026',
  name: 'Prime IV — PDM April 2026 Calendar',
  description:
    'Actual April 2026 social content calendar from PDM (the brand agency for Prime IV). Spring Momentum + Stress Support theme. Load into Niceville\'s calendar so MNA can see what PDM is posting brand-wide and plan complementary local content. Includes 2 local (non-cascading) reels PDM expects the location to post from its own page.',
  items: [
    // Wk 4/1
    ...
    // Wk 4/12
    { day: 13, platform: 'Instagram', content_type: 'Post', phase: 'PDM · Brand Cascade',
    ...
    { day: 24, platform: 'Instagram', content_type: 'Post', phase: 'PDM · Brand Cascade',
...
// ─── VORTEX — SUMMER & EVENTS ───────────────────────────────────────
// Vortex Spring — campground + natural spring with diving, swimming, and
// holiday music events. Adventurous, outdoorsy voice. Non-cascading MNA
// content (renders normal, not blue). Load with startDate=2026-07-01 for
// July dates; reuse/re-theme for other summer months.
export const VORTEX_SUMMER_2026: Playbook = {
  id: 'vortex-summer-2026',
  name: 'Vortex — Summer & Events',
  description:
    'Summer season content for Vortex Spring — crystal-clear swimming + diving, camping, and holiday live-music weekends. Adventurous outdoor voice. Load into the Vortex calendar and adjust dates per weekend/event.',
  items: [
    { day: 1, platform: 'Instagram', content_type: 'Post', phase: 'Summer Season',
      title: 'Spring Season Is Open',
      hook: '72°F crystal-clear water, all summer long.',
      cta: 'Plan your visit — link in bio',
      caption: `Dive in. 💦 The spring is crystal clear and a constant 72°F — the best way to beat the Florida heat. Swim, snorkel, dive, or just float the day away.\n\n📍 Vortex Spring\n🏕️ Camp · 🤿 Dive · 🎶 Live music weekends\n\n#VortexSpring #FloridaSprings #SpringLife #SwimmingHole #FloridaAdventures #GetOutside` },
    { day: 3, platform: 'Instagram', content_type: 'Reel', phase: 'Dive & Swim',
      title: 'POV: your first jump',
      hook: 'That first jump into the spring hits different.',
      cta: 'Tag who you’re bringing',
      caption: `POV: it’s 95° out and you just found the coldest, clearest water in Florida. 🥶💙 Rope swing, platform jumps, and gin-clear spring water waiting.\n\nWho are you bringing? 👇\n\n#VortexSpring #FloridaSprings #SummerVibes #JumpIn #SwimmingHole #FloridaAdventures` },
    { day: 4, platform: 'Instagram', content_type: 'Post', phase: 'Holiday Event',
      title: '4th of July Weekend Bash',
      hook: 'Camp, swim, and live music for the 4th.',
      cta: 'Reserve your site now',
      caption: `🎆 Red, white & VORTEX. Spend the 4th where the water’s cold and the music’s hot. Live bands, campfires, swimming, and diving all weekend long.\n\nSites fill fast for holiday weekends — lock yours in now. 🏕️🎶\n\n📍 Vortex Spring\n\n#FourthOfJuly #VortexSpring #LiveMusic #CampingLife #FloridaSprings #HolidayWeekend` },
    { day: 6, platform: 'Facebook', content_type: 'Post', phase: 'Camping',
      title: 'Book Your Campsite',
      hook: 'Tent, RV, or cabin — your weekend HQ.',
      cta: 'Book your site',
      caption: `Make a weekend of it. 🏕️ Tent sites, RV hookups, and cabins right by the spring — wake up and walk straight to the water. Weekends book up fast in summer, so grab your spot early.\n\nReserve now 👉 [link]\n\n#VortexSpring #CampingLife #RVlife #FloridaCamping #WeekendGetaway` },
    { day: 8, platform: 'Instagram', content_type: 'Post', phase: 'Dive & Swim',
      title: 'Cavern & Cave Diving',
      hook: 'Certified divers — the cavern is calling.',
      cta: 'Book a dive / see our shop',
      caption: `🤿 One of Florida’s favorite dive spots for a reason. Explore the cavern, log some bottom time in crystal-clear water, and grab air fills and gear right at our on-site dive shop. Open-water and cave divers welcome.\n\nNot certified yet? Ask us about lessons. 💙\n\n#ScubaDiving #CaveDiving #VortexSpring #DiveLife #FloridaDiving #PADI` },
    { day: 10, platform: 'Instagram', content_type: 'Reel', phase: 'Dive & Swim',
      title: 'Underwater at Vortex',
      hook: 'Visibility for days.',
      cta: 'Come see it yourself',
      caption: `The kind of clarity you have to see to believe. 🐟💎 Snorkelers and divers, this one’s your happy place.\n\n#VortexSpring #Underwater #ScubaDiving #Snorkeling #CrystalClear #FloridaSprings` },
    { day: 12, platform: 'Instagram', content_type: 'Post', phase: 'Summer Season',
      title: 'Family Day at the Spring',
      hook: 'Screen-free, splash-filled family fun.',
      cta: 'Plan your family day',
      caption: `Bring the whole crew. 👨‍👩‍👧‍👦 Shallow areas for the little ones, jumps for the brave, shade and picnic spots for everyone. A real Florida spring day the kids will actually remember.\n\n#FamilyFun #VortexSpring #FloridaSprings #SummerWithKids #MakeMemories` },
    { day: 15, platform: 'Instagram', content_type: 'Post', phase: 'Summer Season',
      title: '72° Year-Round',
      hook: 'While everyone else is melting…',
      cta: 'Cool off this weekend',
      caption: `The spring doesn’t care that it’s 95° out. 😎 A steady 72°F means the perfect cool-down every single day of summer. Nature’s air conditioning.\n\n#BeatTheHeat #VortexSpring #FloridaSprings #SummerVibes #NaturalSpring` },
    { day: 17, platform: 'Facebook', content_type: 'Post', phase: 'Camping',
      title: 'RV & Tent Sites Available',
      hook: 'Roll in, set up, walk to the water.',
      cta: 'Check availability',
      caption: `Full RV hookups and shady tent sites still open for upcoming weekends. 🚐⛺ Bring the rig, the tent, and the whole crew — the spring’s right there when you wake up.\n\nCheck dates 👉 [link]\n\n#RVlife #Camping #VortexSpring #FloridaCamping #Weekender` },
    { day: 19, platform: 'Instagram', content_type: 'Reel', phase: 'Dive & Swim',
      title: 'Rope Swing + Platform Jumps',
      hook: 'Send it. 🪂',
      cta: 'Tag your jump buddy',
      caption: `Rope swing? ✅ Platform jumps? ✅ Ice-cold landing? ✅ This is the summer content your feed needs.\n\n#VortexSpring #RopeSwing #SendIt #SummerVibes #FloridaSprings #SwimmingHole` },
    { day: 22, platform: 'Instagram', content_type: 'Post', phase: 'Live Music',
      title: 'Live Music This Weekend',
      hook: 'Cold water by day, live bands by night.',
      cta: 'Grab your spot',
      caption: `🎶 The lineup’s set. Spend the day in the spring and the evening by the stage — good music, good people, campfire vibes. Bring your chair and your crew.\n\nCamping + music = the perfect weekend. See you there.\n\n#LiveMusic #VortexSpring #CampfireVibes #WeekendPlans #FloridaSprings` },
    { day: 24, platform: 'Instagram', content_type: 'Post', phase: 'Dive & Swim',
      title: 'Dive Shop & Gear On-Site',
      hook: 'Forgot your gear? We’ve got you.',
      cta: 'Stop by the shop',
      caption: `Snorkels, masks, fins, air fills, and rentals — our on-site shop has what you need to get in the water. New to diving? Our team will point you the right way. 🤿\n\n#DiveShop #VortexSpring #Snorkeling #ScubaDiving #FloridaDiving` },
    { day: 26, platform: 'Instagram', content_type: 'Post', phase: 'Camping',
      title: 'Groups & Private Events',
      hook: 'Reunions, clubs, birthdays — book the spring.',
      cta: 'Message us to plan',
      caption: `Planning a group trip? 🎉 Family reunions, dive clubs, birthdays, church groups — Vortex is built for it. Camping, swimming, diving, and space for everyone.\n\nDM us to plan your group weekend. 💙\n\n#GroupTrip #VortexSpring #Reunion #PrivateEvent #FloridaSprings` },
    { day: 29, platform: 'Instagram', content_type: 'Post', phase: 'Summer Season',
      title: 'Sunset by the Spring',
      hook: 'Stay for the golden hour.',
      cta: 'Book your weekend',
      caption: `The best part of a day at the spring? Not wanting to leave. 🌅 Stay the night, catch the sunset, and do it all again tomorrow.\n\nBook your weekend 👉 [link]\n\n#GoldenHour #VortexSpring #CampingLife #FloridaSprings #WeekendGetaway` },
  ],
};
