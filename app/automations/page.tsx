  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-0.5">Build workflows and automate repetitive tasks</p>
      </div>
      <Card className="p-12 flex flex-col items-center justify-center text-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1 max-w-sm">Build workflows, trigger sequences, and automate repetitive tasks across your stack.</p>
        </div>
