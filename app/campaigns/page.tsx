...
export default function CampaignsPage() {
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        <h1 className="text-2xl font-black text-gray-900">Campaign Manager</h1>
        <p className="text-sm text-gray-400 mt-0.5">Build, launch, and optimize campaigns across all platforms</p>
      </div>
      <Card className="p-12 flex flex-col items-center justify-center text-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1 max-w-sm">Build, launch, and optimize campaigns across all platforms from a single control center.</p>
        </div>
