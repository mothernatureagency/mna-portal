...
export default function ContentPage() {
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        <h1 className="text-2xl font-black text-gray-900">Content Studio</h1>
        <p className="text-sm text-gray-400 mt-0.5">Plan, create, schedule, and analyze your content strategy</p>
      </div>
      <Card className="p-12 flex flex-col items-center justify-center text-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1 max-w-sm">Plan, create, schedule, and analyze your content strategy across every channel.</p>
        </div>
