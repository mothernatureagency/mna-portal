  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-0.5">Track and manage all your leads in one place</p>
      </div>
      <Card className="p-12 flex flex-col items-center justify-center text-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1 max-w-sm">Track and manage all your leads in one place. Connect your forms, ads, and CRM for a unified view.</p>
        </div>
